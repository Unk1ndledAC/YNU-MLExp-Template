...
\pagestyle{fancy}
\fancyhead[L]{}
\fancyhead[C]{\fangsong 智能科学与技术机器学习实验（2026春）课程论文}
\fancyhead[R]{}
...
学号\ \underline{2021XXXXXXX} \qquad
}
\date{} % 留空，不显示日期
...
\begin{equation*}
    h_{i,j}^k = \theta \frac{adafadsjfmlqewjowqefj}{2183798729534}
\end{equation*}
